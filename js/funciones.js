...
export function siguientenivel() {
    ...
    alert(`CORRECTOOOO!!! su puntaje es de ${localStorage.getItem('puntaje')} ptos`) 
   
}
/**
 * @function reset() esta funcion tiene como proposito reiniciar los niveles y los puntages del jugador al escoger una opcion erronea.
 */

export function reset(){
    alert(":( Lo siento "+localStorage.getItem("nombre")+ "Mejor suerte para la proxima, tu puntaje fue "+localStorage.getItem("puntaje"))
...
export function verification(button,array,){   
    if (button.checked) {
         if(array===button.id){
             siguientenivel()
         }
